...
describe('Listening History (e2e)', () => {
    ...
    beforeAll(async () => {
        ...
        // L'utilisateur de test doit être administrateur,
        // car POST /genres est désormais protégé par AdminGuard.
