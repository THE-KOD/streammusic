...
import { LikedTrackActions } from './liked-track-actions'
...
export function LikedTrackRow({ track, onPlay, onRemove }: LikedTrackRowProps) {
    return (
        <div
            className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-surface transition-colors cursor-pointer group"
            onClick={onPlay}
        >
            ...
            <LikedTrackActions onRemove={onRemove} />
        </div>
    )
}