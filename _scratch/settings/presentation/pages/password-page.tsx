...
export function PasswordPage() {
    ...
    // Simuler un compte avec OAuth (pour la démo)
    const isOAuthAccount = false // true pour tester le cas OAuth
        ...
        <div>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-2.5 top-1/2 -translate-y-1/2 text-muted hover:text-ivory"
                            >
                    ...
                    <Button variant="primary" size="lg" onClick={handleSubmit} disabled={isLoading} className="w-full md:w-auto">
