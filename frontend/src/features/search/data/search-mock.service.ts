...
const MOCK_TRACKS = [
    { id: 't1', title: 'Midnight Drive', artistName: 'Nova Kline', artistId: 'a1', albumTitle: 'Neon Static', albumId: 'al1', duration: 222, fileUrl: '' },
    { id: 't2', title: 'Glass Horizon', artistName: 'The Reverbs', artistId: 'a2', albumTitle: 'Low Tide', albumId: 'al2', duration: 251, fileUrl: '' },
]
