  ...
  return (
      <>
        ...
        <section className="mb-8">
          ...
          {!recommendations.isLoading && !recommendations.error && recommendations.data.length === 0 && (
              <EmptyState message="Nous n'avons pas encore assez d'écoute pour personnaliser vos recommandations." />
          )}
